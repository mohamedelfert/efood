<?php return array(
  ...
  'currencies_setup' => 'Currencies Setup',
  'currency_list' => 'Currency List',
  'main_currency' => 'Main Currency',
  'branches_setup' => 'Branches Setup',
  'branches' => 'Branches',
  'add_new_branch' => 'Add New Branch',
  'branch_list' => 'Branch list',
  'branch_coverage' => 'Branch Coverage',
  'employees_setup' => 'Employees Setup',
  'employees' => 'Employees',
  'employee_role_setup' => 'Employee role setup',
  'add_new_employee' => 'Add New Employee',
  'employee_list' => 'Employee List',
  'wallet_payment_setup' => 'Wallet & Payments Setup',
  'wallet' => 'Wallet',
  ...
  'Ex: 1.0000' => 'Ex: 1.0000',
  'rate_against_primary_currency' => 'Rate against primary currency',
  'update_exchange_rates_against_primary_currency' => 'Update exchange rates against primary currency',
  'exchange_rate_is_fixed_at_1.0000' => 'Exchange rate is fixed at 1.0000',
  ...
  'Primary currency rate is fixed at 1.0000' => 'Primary currency rate is fixed at 1.0000',
  'Update Currency' => 'Update Currency',
  'Update Exchange Rates' => 'Update Exchange Rates',
  'Current Exchange Rates' => 'Current Exchange Rates',
  'Update exchange rates against primary currency' => 'Update exchange rates against primary currency',
  'Last Updated' => 'Last Updated',
  'Primary Currency' => 'Primary Currency',
  'Exchange rate is fixed at 1.0000' => 'Exchange rate is fixed at 1.0000',
  'Currency' => 'Currency',
  'Current Rate' => 'Current Rate',
  'Example' => 'Example',
  'Primary' => 'Primary',
  'Important Notes' => 'Important Notes',
  'Exchange rates affect all product prices and orders' => 'Exchange rates affect all product prices and orders',
  'Primary currency rate is always 1.0000 and cannot be changed' => 'Primary currency rate is always 1.0000 and cannot be changed',
  'You can edit individual currencies from the currency list page' => 'You can edit individual currencies from the currency list page',
  'Consider integrating with external API for real-time rates' => 'Consider integrating with external API for real-time rates',
  ...
  'cannot_delete_customer_with_wallet_balance' => 'Cannot delete customer with existing wallet balance. Please clear the balance first.',
  'cannot_delete_customer_with_balance' => 'Cannot delete customer with wallet balance:',
  // QR Code
  'Invalid QR code format' => 'Invalid QR code format',
  'QR code is not for wallet transfer' => 'QR code is not for wallet transfer',
  'User not found or QR code is invalid' => 'User not found or QR code is invalid',
  'Failed to validate QR code' => 'Failed to validate QR code',
  'Failed to generate QR code' => 'Failed to generate QR code',
  'Failed to regenerate QR code' => 'Failed to regenerate QR code',
  'Share this QR code to receive money' => 'Share this QR code to receive money',
  'QR code regenerated successfully' => 'QR code regenerated successfully',
  'Receiver verified successfully' => 'Receiver verified successfully',
  'You cannot transfer money to yourself' => 'You cannot transfer money to yourself',
  'Receiver account is not active' => 'Receiver account is not active',
  'Failed to send OTP' => 'Failed to send OTP',
  'Pending transfer cancelled successfully' => 'Pending transfer cancelled successfully',
  'No pending transfer found' => 'No pending transfer found',
  'Pending transfer expired' => 'Pending transfer expired',
  'Wallet QR Code' => 'Wallet QR Code',
  'Customer QR Code' => 'Customer QR Code',
  ...
  'This QR code can be used to receive money transfers from other users.' => 'This QR code can be used to receive money transfers from other users.',
  'Customer already has a QR code. Use regenerate instead.' => 'Customer already has a QR code. Use regenerate instead.',
  'Failed to generate QR code. Check logs for details.' => 'Failed to generate QR code. Check logs for details.',
  'QR code generated successfully' => 'QR code generated successfully',
  'Failed to regenerate QR code. Check logs for details.' => 'Failed to regenerate QR code. Check logs for details.',
  'Customer does not have a QR code' => 'Customer does not have a QR code',
  'QR code file not found' => 'QR code file not found',
  'Failed to download QR code' => 'Failed to download QR code',
  'Customer does not have a QR code yet' => 'Customer does not have a QR code yet',
  'Print QR Code' => 'Print QR Code',
  'total_offer_price' => 'Total Offer Price',
  ...
  'The final price customer will pay for all items' => 'The final price customer will pay for all items',
  'Percentage discount on total original price' => 'Percentage discount on total original price',
  'Total Original' => 'Total Original',
  'Offer Price' => 'Offer Price',
  'Back to Customer' => 'Back to Customer',
  'How to use this QR code:' => 'How to use this QR code:',
  'Open the mobile app' => 'Open the mobile app',
  'Go to Wallet section' => 'Go to Wallet section',
  'Select "Send Money"' => 'Select "Send Money"',
  'Scan this QR code' => 'Scan this QR code',
  'Enter amount and confirm transfer' => 'Enter amount and confirm transfer',
  'Scan this QR code to send money to this customer' => 'Scan this QR code to send money to this customer',
  'Balance Summary' => 'Balance Summary',
  'Wallet Balance Summary' => 'Wallet Balance Summary',
  'Customer Wallet Statement' => 'Customer Wallet Statement',
  'Transaction Breakdown by Type' => 'Transaction Breakdown by Type',
  'Opening Balance' => 'Opening Balance',
  'Closing Balance' => 'Closing Balance',
  'Period From' => 'Period From',
  'Period To' => 'Period To',
  "cashback_management" => "Cashback Management",
  "cashback_settings" => "Cashback Settings",
  "cashback_statistics" => "Cashback Statistics",
  "cashback_title" => "Cashback Title",
  "cashback_for" => "Cashback For",
  ...
  "total_cashback_given" => "Total Cashback Given",
  "wallet_topup_cashback" => "Wallet Top-up Cashback",
  "order_cashback" => "Order Cashback",
  "this_month" => "This Month",
  "all_time" => "All Time",
  "top_users_by_cashback" => "Top 10 Users by Cashback Earned",
  "cashback_distribution" => "Cashback Distribution",
  "quick_stats" => "Quick Stats",
  "avg_per_user" => "Average per User",
  "total_users" => "Total Users",
  "cashback_roi" => "Cashback ROI",
  "cashback_helps_retain" => "Cashback helps retain customers and increase transaction frequency",
  "no_cashback_data" => "No cashback data available yet",
  "view_statistics" => "View Statistics",
  "manage_settings" => "Manage Settings",
  "cashback_earned" => "Cashback Earned",
  "you_earned_cashback" => "You earned {amount} cashback!",
  "cashback_on_order" => "Cashback on order",
  "cashback_on_topup" => "Cashback on wallet top-up",
  "earn_cashback" => "Earn Cashback",
  "get_cashback_on_orders" => "Get cashback on your orders",
  "get_cashback_on_topups" => "Get cashback on wallet top-ups",
  ...
  'Statement Generated on' => 'Statement Generated on',
  ...
  'banner_type_required' => 'Offer type is required',
  ...
  'banner_added_successfully' => 'Offer added successfully!',
  'banner_updated_successfully' => 'Offer updated successfully!',
  ...
  'update_banner' => 'Update Offer',
  'banner_list' => 'Offer List',
  'banner_type' => 'Offer Type',
  'select_banner_type' => 'Select Offer Type',
  ...
  'Title is too long' => 'Title is too long',
  'Banner added successfully!' => 'Offer added successfully!',
  ...
  'special_system_management' => 'Special System Management',
  ...
  'Banner removed!' => 'Offer removed!',
  'Banner status updated!' => 'Offer status updated!',
  ...
  'Banner updated successfully!' => 'Offer updated successfully!',
  'branch_image' => 'Branch image',
  ' Ex' => ' Ex',
  ...
  'Invalid or completed transaction' => 'Invalid or completed transaction',
  ...
  'No pending transfer found' => 'No pending transfer found',
  'Insufficient loyalty points' => 'Insufficient loyalty points',
  'since your wallet balance is more than order amount, you can not place partial order' => 'Since your wallet balance is more than order amount, you can not place partial order',
  ...
  'Product not found for ID: 1' => 'Product not found for ID: 1',
  'Failed to create wallet transaction' => 'Failed to create wallet transaction',
  'failed_to_create_transaction' => 'Failed to create transaction',
  'Add-on not found for ID: 1' => 'Add-on not found for ID: 1',
  ...
  'Wallet PIN updated successfully' => 'Wallet PIN updated successfully',
  ...
  'Insufficient stock for product :name. Only :count items available. Please order less.' => 'Insufficient stock for product :name. Only :count items available. Please order less.',
  'Product :name is out of stock' => 'Product :name is out of stock',
  'Product not available' => 'Product not available',
  'Product not available in branch' => 'Product not available in branch',
  'Product not found' => 'Product not found',
  'Product is currently unavailable' => 'Product is currently unavailable',
  'Product is currently unavailable in this branch' => 'Product is currently unavailable in this branch',
  'Add-on not found for ID: :id' => 'Add-on not found for ID: :id',
  'Cart is empty' => 'Cart is empty',
  'Some items are out of stock or have insufficient quantity. Please adjust your order.' => 'Some items are out of stock or have insufficient quantity. Please adjust your order.',
  'All cart items are valid and available' => 'All cart items are valid and available',
  'Some cart items have issues. Please adjust your order.' => 'Some cart items have issues. Please adjust your order.',
  'Low stock warning for product :name. Only :count items left.' => 'Low stock warning for product :name. Only :count items left.',
  'Selected variation may not be available' => 'Selected variation may not be available',
  'Product :name is available.' => 'Product :name is available.',
  'Product data inconsistency detected' => 'Product data inconsistency detected',
  'Customer wallet status is disabled' => 'Customer wallet status is disabled',
  'You do not have sufficient balance in wallet' => 'You do not have sufficient balance in wallet',
  'Since your wallet balance is more than order amount, you cannot place partial order' => 'Since your wallet balance is more than order amount, you cannot place partial order',
  'Since your wallet balance is less than 1, you cannot place partial order' => 'Since your wallet balance is less than 1, you cannot place partial order',
  'Invalid payment gateway' => 'Invalid payment gateway',
  'User not found' => 'User not found',
  'invalid_amount' => 'Order amount must be at least 0.01',
);
            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['product_management']))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/category*') ? 'active' : ''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                    ...
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Categories_Setup')}}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                    ...
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Products_Setup')}}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle"> {{translate('management')}} {{translate('Employees')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['user_management']))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/customer/transaction') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') || Request::is('admin/customer/settings') ? 'block' : ''}}">
                                    <li
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/customer/wallet*') ? 'block' : ''}}">
                                    ...
                                    <li
                                        class="nav-item {{Request::is('admin/customer/wallet/balance-summary*') ? 'active' : ''}}">
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{Request::is('admin/customer/cashback*') ? 'active' : ''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/customer/cashback*') ? 'block' : ''}}">
                                    <li
                                        class="nav-item {{Request::is('admin/customer/cashback') || Request::is('admin/customer/cashback/index') ? 'active' : ''}}">
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['help_and_support_management']))
                            <li class="nav-item">
                                <small class="nav-subtitle"
                                    title="{{translate('Help_&_Support_Section')}}">{{translate('Help_&_Support_Section')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                        ...
                        <!-- Special Settings -->
                        <li
                            class="navbar-vertical-aside-has-menu {{Request::is('admin/kitchen*') || Request::is('admin/table*') || Request::is('admin/verify-offline-payment*') || Request::is('admin/delivery-man*') || Request::is('admin/report/earning') || Request::is('admin/system-addon*') || Request::is('admin/pos*') || Request::is('admin/business-settings/email-setup*') || Request::is('admin/business-settings/web-app/third-party*') || Request::is('admin/customer/loyalty-point*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                <i class="tio-settings nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Special
                                    Settings')}}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{Request::is('admin/kitchen*') || Request::is('admin/table*') || Request::is('admin/verify-offline-payment*') || Request::is('admin/delivery-man*') || Request::is('admin/report/earning') || Request::is('admin/system-addon*') || Request::is('admin/pos*') || Request::is('admin/business-settings/email-setup*') || Request::is('admin/business-settings/web-app/third-party*') || Request::is('admin/customer/loyalty-point*')?'block':'none'}}">
                                <!-- Cuisine -->
                                ...
                                <!-- <li class="navbar-vertical-aside-has-menu {{Request::is('admin/kitchen*')?'active':''}}">
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('admin/kitchen*')?'block':'none'}}">
                                ...
                                <!-- <li class="navbar-vertical-aside-has-menu {{Request::is('admin/table*')?'active':''}}">
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('admin/table*')?'block':'none'}}">
                                ...
                                <!-- <li class="navbar-vertical-aside-has-menu {{Request::is('admin/report/earning')?'active':''}}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.report.earning')}}">
                                            <i class="tio-chart-pie-1 nav-icon"></i>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Earning Report')}}</span>
                                        </a>
                                    </li> -->

        ...
        <table class="main">
            ...
            <tr>
                <td class="content">
                    ...
                    <h1 class="mail-title">✧ {{ $title ?? translate('Transaction_Notification') }} ✧</h1>
                    ...
                    <table class="transaction-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $time }}</td>
                                <td style="font-weight: 700;">{{ \App\CentralLogics\Helpers::format_currency($amount) }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    @if (isset($data) && $data->button_url)
                        <div style="text-align: center; margin-bottom: 30px;">
                            <a href="{{ $data->button_url }}"
                                class="submit-btn">{{ $data->button_name ?? translate('View_Statement') }}</a>
                        </div>
                    @endif

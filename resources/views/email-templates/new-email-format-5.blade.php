        ...
        <table class="main">
            ...
            <tr>
                <td class="content">
                    ...
                    <h1 class="mail-title">✧ {{ $title ?? translate('Password_Reset') }} ✧</h1>

                    <div class="mail-body">
                        {!! $body ?? '' !!}
                        @if (isset($url))
                            <div style="margin-top: 15px;">
                                <a href="{{ $url }}" style="color: #A07855; word-break: break-all;">{{ $url }}</a>
                            </div>
                        @endif
                    </div>
                    ...
                    @if (isset($data) && $data->button_url)
                        <a href="{{ $data->button_url }}"
                            class="submit-btn">{{ $data->button_name ?? translate('Reset_Password') }}</a>
                    @endif

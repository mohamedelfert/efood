...
<head>
    ...
    <title>Confirm Money Transfer from Wallet</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>An OTP (One-Time Password) has been sent to your email to confirm the money transfer from your wallet.</p>
            ...
            <div class="warning-box">
                ...
                <ul style="margin: 10px 0 0 0; padding-left: 20px;">
                    ...
                    <li>Complete the transfer within 10 minutes</li>

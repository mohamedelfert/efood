                ...
                <div class="col-8">
                    @if($config)
                        <div class="d-flex flex-wrap gap-3 align-items-center">
                            <p class="mb-0">
                                @if($config)
                                    ...
                                    @if(isset($selectedMaintenanceDuration['maintenance_duration']) && $selectedMaintenanceDuration['maintenance_duration'] != 'until_change')
                                        {{ translate('from ') }}{{ $startDate->format('m/d/Y, h:i A') }} to
                            ...
                            <a class="btn btn-outline-primary btn-sm edit square-btn maintenance-mode-show" href="#"><i
                                    class="tio-edit"></i></a>
                        </div>
                    @else
                        <p>*{{ translate('By turning on maintenance mode Control your all system & function') }}</p>
                    ...
                    <div class="d-flex justify-content-between align-items-center border rounded mb-2 px-3 py-2">
                        ...
                        <label class="switcher ml-auto mb-0">
                            <input type="checkbox" class="switcher_input @if(!$config) maintenance-mode-show @endif"
                                @if($config) onclick="maintenance_mode()" @endif id="maintenance-mode-input" {{ $config ? 'checked' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$restaurant_name}}" name="restaurant_name" class="form-control"
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="email" value="{{$email}}" name="email" class="form-control"
                                placeholder="{{translate('Ex: contact@company.com')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea name="address" class="form-control"
                                placeholder="{{translate('Ex: ABC Company')}}">{{$address}}</textarea>
                        </div>
                    </div>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="time_format" class="form-control js-select2-custom">
                                <option value="12" {{$time_format == '12' ? 'selected' : ''}}>{{translate('12_hour')}}
                                </option>
                                <option value="24" {{$time_format == '24' ? 'selected' : ''}}>{{translate('24_hour')}}
                                </option>
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="">
                                ...
                                <div class="form-control d-flex flex-column-2">
                                    <div class="custom-radio d-flex gap-2 align-items-center"
                                        ...
                                        <input type="radio" class="" name="projectViewNewProjectTypeRadio"
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" value="{{$decimal_point_settings}}" name="decimal_point_settings"
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="number" value="{{$pagination_limit}}" min="0" name="pagination_limit"
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                            ...
                            <label class="switcher">
                                <input class="switcher_input" type="checkbox" name="toggle_veg_non_veg"
                                    {{$vnv_status == null || $vnv_status == 0 ? '' : 'checked'}} id="toggle_veg_non_veg">
                                <span class="switcher_control"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                            ...
                            <label class="switcher">
                                <input class="switcher_input" type="checkbox" name="dm_self_registration"
                                    {{$dm_status == null || $dm_status == 0 ? '' : 'checked'}} id="dm_self_registration">
                                <span class="switcher_control"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        @php($ta = \App\CentralLogics\Helpers::get_business_settings('take_away'))
                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                            <div>
                                <label class="text-dark mb-0">{{translate('take_away')}}
                                    <i class="tio-info-outined" data-toggle="tooltip" data-placement="top"
                                        title="{{ translate('When this option is enabled the user may place take away orders.') }}">
                                    </i>
                                </label>
                            </div>
                            <label class="switcher">
                                <input class="switcher_input" type="checkbox" name="take_away" {{$ta == null || $ta == 0 ? '' : 'checked'}} id="take_away_btn">
                                <span class="switcher_control"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        @php($ic = \App\CentralLogics\Helpers::get_business_settings('in_car'))
                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                            <div>
                                <label class="text-dark mb-0">{{translate('in_car')}}
                                    <i class="tio-info-outined" data-toggle="tooltip" data-placement="top"
                                        title="{{ translate('When this option is enabled the user may place in car orders.') }}">
                                    </i>
                                </label>
                            </div>
                            <label class="switcher">
                                <input class="switcher_input" type="checkbox" name="in_car" {{$ic == null || $ic == 0 ? '' : 'checked'}} id="in_car_btn">
                                <span class="switcher_control"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        @php($di = \App\CentralLogics\Helpers::get_business_settings('dine_in'))
                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                            <div>
                                <label class="text-dark mb-0">{{translate('dine_in')}}
                                    <i class="tio-info-outined" data-toggle="tooltip" data-placement="top"
                                        title="{{ translate('When this option is enabled the user may place dine in orders.') }}">
                                    </i>
                                </label>
                            </div>
                            <label class="switcher">
                                <input class="switcher_input" type="checkbox" name="dine_in" {{$di == null || $di == 0 ? '' : 'checked'}} id="dine_in_btn">
                                <span class="switcher_control"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                            ...
                            <label class="switcher">
                                <input class="switcher_input" type="checkbox" name="guest_checkout"
                                    {{$guest_checkout == null || $guest_checkout == 0 ? '' : 'checked'}}
                                    id="guest_checkout">
                                <span class="switcher_control"></span>
                            </label>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                            ...
                            <label class="switcher">
                                <input class="switcher_input" type="checkbox" name="partial_payment"
                                    {{$partial_payment == null || $partial_payment == 0 ? '' : 'checked'}}
                                    id="partial_payment">
                                <span class="switcher_control"></span>
                            </label>
                        </div>
                ...
                <div class="row align-items-end">
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="input-label">{{translate('Combine Payment With')}}
                                ...
                                <span
                                    class="font-size-sm text-muted">({{ translate('if the particular payment method status is off then that selection option will be disable. Change the payment status from') }}
                                    <a class="text-decoration-underline"
                                        href="{{ route('admin.business-settings.web-app.payment-method') }}"
                                        target="_blank">{{ translate('Payment Method Setup') }}</a>)</span>
                            </label>

                            <select name="partial_payment_combine_with" class="form-control">
                                <option value="COD" {{(isset($combine_with) && $combine_with == 'COD') ? 'selected' : ''}}
                                    {{ $cod['status'] == 0 ? 'disabled' : '' }}>
                                    {{ translate('COD') }}
                                </option>
                                ...
                                <option value="all" {{(isset($combine_with) && $combine_with == 'all') ? 'selected' : ''}}
                                    {{ $cod['status'] == 0 || $digital['status'] == 0 || $offline['status'] == 0 ? 'disabled' : '' }}>
                                    {{ translate('All') }}
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$footer_text}}" name="footer_description_text"
                                class="form-control" placeholder="{{translate('Ex: description')}}" required>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                            ...
                            <label class="switcher">
                                <input class="switcher_input" type="checkbox" name="google_map_status"
                                    {{$google_map_status == null || $google_map_status == 0 ? '' : 'checked'}}
                                    id="google_map_status">
                                <span class="switcher_control"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                            ...
                            <label class="switcher">
                                <input class="switcher_input" type="checkbox" name="admin_order_notification"
                                    {{$admin_order_notification == null || $admin_order_notification == 0 ? '' : 'checked'}}
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                ...
                                <div class="form-control d-flex flex-column-2">
                                    <div class="custom-radio d-flex gap-2 align-items-center">
                                        <input type="radio" class="" value="manual" name="admin_order_notification_type"
                                    ...
                                    <div class="custom-radio d-flex gap-2 align-items-center">
                                        <input type="radio" class="" value="firebase"
                                            name="admin_order_notification_type" id="admin_order_notification_type2"
                            ...
                            <div class="col-xl-8">
                                <div class="border p-3">
                                    <div class="d-flex flex-wrap gap-5 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="maintenance_duration" {{ isset($selectedMaintenanceDuration['maintenance_duration']) && $selectedMaintenanceDuration['maintenance_duration'] == 'one_day' ? 'checked' : '' }} value="one_day" id="one_day">
                                            <label class="form-check-label"
                                                for="one_day">{{ translate('For 24 Hours') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="maintenance_duration" {{ isset($selectedMaintenanceDuration['maintenance_duration']) && $selectedMaintenanceDuration['maintenance_duration'] == 'one_week' ? 'checked' : '' }} value="one_week" id="one_week">
                                            <label class="form-check-label"
                                                for="one_week">{{ translate('For 1 Week') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="maintenance_duration" {{ isset($selectedMaintenanceDuration['maintenance_duration']) && $selectedMaintenanceDuration['maintenance_duration'] == 'until_change' ? 'checked' : '' }} value="until_change" id="until_change">
                                            <label class="form-check-label"
                                                for="until_change">{{ translate('Until I change') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="maintenance_duration" {{ isset($selectedMaintenanceDuration['maintenance_duration']) && $selectedMaintenanceDuration['maintenance_duration'] == 'customize' ? 'checked' : '' }} value="customize" id="customize">
                                            <label class="form-check-label"
                    ...
                    <div id="advanceFeatureButtonDiv">
                        <div class="d-flex justify-content-center mt-3">
                            <a href="#" id="advanceFeatureToggle"
                                class="d-block mb-3 maintenance-advance-feature-button">{{ translate('Advance Feature') }}</a>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-8">
                            <div class="border p-3">
                                <div class="form-group">
                                    ...
                                    <div class="d-flex flex-wrap gap-5 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="business_number" {{ isset($selectedMaintenanceMessage['business_number']) && $selectedMaintenanceMessage['business_number'] == 1 ? 'checked' : '' }}
                                                id="businessNumber">
                                            <label class="form-check-label"
                                                for="businessNumber">{{ translate('Business Number') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="business_email" {{ isset($selectedMaintenanceMessage['business_email']) && $selectedMaintenanceMessage['business_email'] == 1 ? 'checked' : '' }}
                                                id="businessEmail">
                                            <label class="form-check-label"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="message_body" maxlength="255" rows="3"
                                        placeholder="{{ translate('Our system is currently undergoing maintenance...') }}">{{ $selectedMaintenanceMessage['message_body'] ?? '' }}</textarea>
                                </div>
                                <div class="form-group">
...
<!-- Modal for Checking -->
<div class="modal fade" id="modalUncheckedDistanceExist" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <div class="text-center">
                    ...
                    <div class="my-4">
                        <a class="btn btn-primary" target="_blank"
                            href="{{ route('admin.business-settings.restaurant.delivery-fee-setup') }}">{{ translate('Go to Delivery Charge Setup') }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-body">
                <div class="">
                    <div class="text-center mb-5">
                        <img src="{{ asset('public/assets/admin/svg/components/map-icon.svg') }}" alt="Unchecked Icon"
                            class="mb-5">
                        <h4>{{ translate('Are You Sure') }}?</h4>
                        <p>{{ translate('Do you want to turn off Google Maps? Turning off the Google Maps setup will affect the following settings') }}:
                        </p>
                    </div>

                    <div class="row g-2">
                        <div class="col-6">
                            <a class="d-flex align-items-center border rounded px-3 py-2 gap-2"
                                href="{{ route('admin.customer.list') }}" target="_blank">
                                <img src="{{ asset('public/assets/admin/svg/components/people.svg') }}" width="21"
                                    alt="">
                        ...
                        <div class="col-6">
                            <a class="d-flex align-items-center border rounded px-3 py-2 gap-2"
                                ...
                                <img src="{{ asset('public/assets/admin/svg/components/branch.svg') }}" width="21"
                                    alt="">
                        ...
                        <div class="col-6">
                            <a class="d-flex align-items-center border rounded px-3 py-2 gap-2"
                                href="{{ route('admin.delivery-man.list') }}" target="_blank">
                                <img src="{{ asset('public/assets/admin/svg/components/delivery-car.svg') }}" width="21"
                                    alt="">
                    ...
                    <div class="my-4">
                        ...
                        <p>{{ translate('By turning on this option, you can be able to see the map on customer app & website, admin panel, branch panel and deliveryman app. You can now also setup your delivery charges based on distance(km) from ') }}
                            <a class="" target="_blank"
                                href="{{ route('admin.business-settings.restaurant.delivery-fee-setup') }}">{{ translate('This Page') }}</a>
                        </p>
                        <p>{{ translate('note') }}:

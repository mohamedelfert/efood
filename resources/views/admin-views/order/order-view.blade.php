...
<div class="content container-fluid">
    ...
    <div class="row" id="printableArea">
                        ...
                        <div class="col-sm-6 d-flex flex-column justify-content-between">
                            <div>
                                ...
                                <h5 class="text-capitalize">
                                    <i class="tio-shop"></i> {{translate('branch')}} : <label class="badge-soft-info px-2 rounded"> {{$order->branch?$order->branch->name:'Branch deleted!'}} </label>
                                </h5>
                                <div class="mt-2 d-flex flex-column">
                                    <h5 class="text-capitalize">
                                        <i class="{{$orderTypeInfo['icon']}}"></i> {{$orderTypeInfo['title']}} <label class="{{$orderTypeInfo['badge_class']}} px-2 rounded">{{$orderTypeInfo['description']}}</label>
                                    </h5>
                                    @if($orderTypeInfo['show_table_details'])
                                    <div class="hs-unfold">
                                        <h5 class="text-capitalize">
                                            <i class="tio-table"></i> {{translate('table no')}} : <label class="badge badge-secondary">{{$orderTypeInfo['table_number'] ?? 'N/A'}}</label>
                                        </h5>
                                    </div>
                                    <div class="hs-unfold">
                                        <h5 class="text-capitalize">
                                            <i class="tio-user"></i> {{translate('number of people')}} : <label class="badge badge-secondary">{{$orderTypeInfo['number_of_people'] ?? 'N/A'}}</label>
                                        </h5>
                                    </div>
                                    @endif
                                    @if($orderTypeInfo['show_car_details'])
                                    <div class="hs-unfold">
                                        <h5 class="text-capitalize">
                                            <i class="tio-car"></i> {{translate('Car_Number')}} : <label class="badge badge-secondary">{{$orderTypeInfo['car_registration'] ?? 'N/A'}}</label>
                                        </h5>
                                    </div>
                                    <div class="hs-unfold">
                                        <h5 class="text-capitalize">
                                            <i class="tio-paint-bucket"></i> {{translate('Car_Color')}} : <label class="badge badge-secondary">{{$orderTypeInfo['car_color'] ?? 'N/A'}}</label>
                                        </h5>
                                    </div>
                                    @endif
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-right">
                                <div class="d-flex flex-wrap gap-2 justify-content-sm-end">
                                    @if($orderTypeInfo['show_delivery_man'])
                                    ...
                                    <div class="hs-unfold ml-1">
                                        ...
                                        @if(isset($origin))
                                        <a class="btn btn-outline-primary" target="_blank" title="{{translate('Delivery Man Last Location')}}" data-toggle="tooltip" data-placement="top" href="https://www.google.com/maps/dir/?api=1&origin={{$origin['latitude']}},{{$origin['longitude']}}&destination={{$current['latitude']}},{{$current['longitude']}}">
                                        ...
                                        @endif
                                        @else
                                        <a class="btn btn-outline-dark last-location-view" href="javascript:" data-toggle="tooltip" data-placement="top" title="{{translate('Only available when order is out for delivery!')}}">
                                            <i class="tio-map"></i> {{translate('Show_Location_in_Map')}}
                                        </a>
                                        @endif
                                    </div>
                                ...
                                <div class="d-flex gap-3 justify-content-sm-end align-items-center mb-3">
                                    {{translate('reference')}} {{translate('code')}} : <button class="btn btn-outline-primary px-3 py-1" data-toggle="modal" data-target=".bd-example-modal-sm"> {{translate('add')}} </button>
                                </div>
                                @elseif($order['order_type']!='pos' && $order['order_type'] != 'dine_in' && $order['order_type'] != 'in_car')
                                <div class="d-flex gap-3 justify-content-sm-end align-items-center mb-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="media gap-3 w-max-content">
                                        <img class="img-fluid avatar avatar-lg" src="{{ $detail->product?->imageFullPath ?? asset('public/assets/admin/img/160x160/img2.jpg') }}" alt="Image Description">
                                        <div class="media-body text-dark fz-12">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <span class="d-block text-capitalize">
                                                    {{ $value['label']}} : <strong>{{Helpers::set_symbol( $value['optionPrice'])}}</strong>
                                                </span>
                                                @endforeach
                                                @else
                    ...
                    <div class="row justify-content-md-end mb-3">
                        <div class="col-md-9 col-lg-8">
                            <dl class="row">
                                ...
                                <dt class="col-6">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span>{{translate('item')}} {{translate('discount')}}</span> <span>:</span>
                                    </div>
                                </dt>
                                <dd class="col-6 text-dark text-right">- {{ Helpers::set_symbol($totalDisOnPro) }}</dd>
                                <dt class="col-6">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span>{{translate('addon')}} {{translate('cost')}}</span> <span>:</span>
                                    </div>
                                </dt>
                                <dd class="col-6 text-dark text-right"> {{ Helpers::set_symbol($addOnsCost) }} </dd>
                                <dt class="col-6">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span>{{translate('coupon')}} {{translate('discount')}}</span> <span>:</span>
                                    </div>
                                </dt>
                                <dd class="col-6 text-dark text-right"> - {{ Helpers::set_symbol($order['coupon_discount_amount']) }}</dd>
                                <dt class="col-6">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span>{{translate('extra discount')}} </span> <span>:</span>
                                    </div>
                                </dt>
                                <dd class="col-6 text-dark text-right"> - {{ Helpers::set_symbol($order['extra_discount']) }}</dd>
                                <dt class="col-6">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span>{{translate('tax')}} / {{translate('vat')}}</span> <span>:</span>
                                    </div>
                                </dt>
                                <dd class="col-6 text-dark text-right">{{ Helpers::set_symbol($totalTax + $addOnsTaxCost) }}</dd>
                                <dt class="col-6">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span> {{translate('subtotal')}}</span> <span>:</span>
                                    </div>
                                </dt>
                                <dd class="col-6 text-dark text-right"> {{ Helpers::set_symbol($subTotal = $subTotal+$totalTax+$addOnsCost-$totalDisOnPro + $addOnsTaxCost - $order['coupon_discount_amount'] - $order['extra_discount']) }}</dd>
                                <dt class="col-6">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span> {{translate('delivery')}} {{translate('fee')}}</span> <span>:</span>
                                    </div>
                                </dt>
                                ...
                                <dt class="col-6 border-top pt-2 fz-16 font-weight-bold">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span>{{translate('total')}}</span> <span>:</span>
                                    </div>
                                </dt>
                                ...
                                <dt class="col-6">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span> {{translate('Paid By')}} ({{str_replace('_', ' ',$partial->paid_with)}})</span> <span>:</span>
                                    </div>
                                </dt>
                                <dd class="col-6 text-dark text-right"> {{ Helpers::set_symbol($partial->paid_amount) }} </dd>
                                @endforeach
                                <?php $due_amount = 0; $due_amount = $order->order_partial_payments->first()?->due_amount; ?>
                                <dt class="col-6">
                                    <div class="d-flex max-w220 ml-auto">
                                        <span> {{translate('Due Amount')}}</span> <span>:</span>
                                    </div>
                                </dt>
                                <dd class="col-6 text-dark text-right"> {{ Helpers::set_symbol($due_amount) }} </dd>
                                @endif
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body text-capitalize d-flex flex-column gap-4">
                    ...
                    <div class="card mt-3">
                        <div class="card-body text-center">
                            ...
                            <div class="mt-3">
                                <button class="btn btn-primary" type="button" data-id="{{ $order['id'] }}" data-target="#payment_verify_modal" data-toggle="modal">{{ translate('Verify_Payment') }} </button>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="hs-unfold w-100">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu text-capitalize" aria-labelledby="dropdownMenuButton">
                                ...
                                @if($order['order_type'] != 'dine_in' && $order['order_type'] != 'in_car')
                    ...
                    <div>
                        <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                            ...
                            <label class="switcher payment-status-text">
                                <input class="switcher_input offline-payment-status-alert" type="checkbox" name="payment_status" value="1" id="payment_status_switch" {{$order->payment_status == 'paid' ?'checked':''}}>
                                <span class="switcher_control"></span>
                            </label>
                            @else
                            <label class="switcher payment-status-text">
                                <input class="switcher_input change-payment-status" type="checkbox" name="payment_status" value="1" data-id="{{ $order['id'] }}" data-status="{{ $order->payment_status == 'paid' ?'unpaid':'paid' }}" {{$order->payment_status == 'paid' ?'checked':''}}>
                                <span class="switcher_control"></span>
                            </label>
                            @endif
                        </div>
                    ...
                    @if($orderTypeInfo['show_delivery_man'] && !$order['delivery_man_id'])
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <h4 class="mb-4 d-flex gap-2">
                        ...
                        <a href="#" data-toggle="modal" data-target="#assignDeliveryMan" class="text--base cursor-pointer ml-auto"> {{translate('Change')}} </a>
                    </h4>
                    ...
                    @php($current=\App\Model\DeliveryHistory::where(['deliveryman_id'=>$order['delivery_man_id'],'order_id'=>$order['id']])->latest()->first())
                    @if(isset($origin))
                    <a target="_blank" class="text-dark" title="Delivery Boy Last Location" data-toggle="tooltip" data-placement="top" href="http://maps.google.com/maps?z=12&t=m&q=loc:{{$current['latitude']}}+{{$current['longitude']}}">
                        <img width="13" src="{{asset('public/assets/admin/img/icons/location.png')}}" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$current['location']?? ''}}
                    </a>
                    @else
                    <a href="javascript:" data-toggle="tooltip" class="text-dark" data-placement="top" title="{{translate('Waiting for location...')}}">
                        <img width="13" src="{{asset('public/assets/admin/img/icons/location.png')}}" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{translate('Waiting for location...')}}
                    </a>
                    @endif
                    @else
                    <a href="javascript:" class="text-dark last-location-view" data-toggle="tooltip" data-placement="top" title="{{translate('Only available when order is out for delivery!')}}">
            ...
            @endif
            @if(in_array($order['order_type'], ['delivery', 'in_car']))
            <div class="card">
                <div class="card-body">
                    <div class="mb-4 d-flex gap-2 justify-content-between">
                        <h4 class="mb-0 d-flex gap-2">
                            <i class="tio-user text-dark"></i> {{translate('Delivery_Informatrion')}}
                        </h4>
                    ...
                    <div class="delivery--information-single flex-column">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <a target="_blank" class="text-dark" href="http://maps.google.com/maps?z=12&t=m&q=loc:{{$address['latitude']}}+{{$address['longitude']}}">
                                <img width="13" src="{{asset('public/assets/admin/img/icons/location.png')}}" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$address['address']}}
                            </a>
                        </div>
                        @endif
                        @endif
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <h4 class="mb-4 d-flex gap-2">
                        <i class="tio-user text-dark"></i> {{ translate('Customer Information') }}
                    </h4>
                    @if($order->is_guest == 1)
                    ...
                    <div class="media flex-wrap gap-3">
                        ...
                        <div class="media-body d-flex flex-column gap-1">
                            <a target="_blank" href="{{route('admin.customer.view',[$order->customer['id']])}}" class="text-dark"><strong>{{$order->customer['name']}}</strong></a>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <h4 class="mb-4 d-flex gap-2">
                        <i class="tio-user text-dark"></i> {{translate('Branch Information')}}
                    </h4>
                    <div class="media flex-wrap gap-3">
                        <div class="">
                    ...
                    <div class="d-flex align-items-center text-dark gap-3">
                        ...
                        <a target="_blank" class="text-dark" href="http://maps.google.com/maps?z=12&t=m&q=loc:{{$order->branch['latitude']}}+{{$order->branch['longitude']}}"> {{$order->branch['address']}}<br>
                        </a>
                    </div>
                    @endif
                </div>
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex flex-wrap align-items-center gap-3 justify-content-between">
                        <div class="media align-items-center gap-2 flex-wrap">
                            <div class="avatar">
                                <img class="img-fit rounded-circle" loading="lazy" decoding="async" src="{{$deliveryMan->imageFullPath}}" alt="Jhon Doe">
                            </div>
            ...
            <form action="{{route('admin.orders.update-shipping')}}" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label" for="">{{ translate('contact_person_name') }} <span class="input-label-secondary text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label" for="">{{ translate('Contact Number') }} <span class="input-label-secondary text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label" for="">{{ translate('latitude') }} <span class="input-label-secondary text-danger">*</span></label>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.orders.update-order-delivery-area', ['order_id' => $order->id]) }}" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        <?php $branch = \App\Model\Branch::with(['delivery_charge_setup', 'delivery_charge_by_area'])
...
<script>
    ...
    var x = setInterval(function() {
        ...
        document.getElementById("counter").innerHTML = Math.abs(days) + "d " + Math.abs(hours) + "h "
        + Math.abs(minutes) + "m " + Math.abs(seconds) + "s " + $text;
        if (distance < 0) {

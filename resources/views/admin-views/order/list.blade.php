                    ...
                    <div class="row gy-3 gx-2 align-items-end">
                        ...
                        <div class="col-12 col-lg-3 d-flex gap-2">
                            <a href="{{route('admin.orders.list', ['all'])}}"
                                class="btn btn-secondary flex-grow-1">{{ translate('Clear') }}</a>
                            <button type="submit"
                ...
                <div class="row g-2">
                        ...
                        <a class="order--card h-100" href="{{route('admin.orders.list', ['status' => 'pending'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('public/assets/admin/img/icons/pending.png')}}" alt=""
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('admin.orders.list', ['status' => 'confirmed'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('public/assets/admin/img/icons/confirmed.png')}}" alt=""
                                        class="oder--card-icon">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('public/assets/admin/img/icons/out_for_delivery.png')}}" alt=""
                                        class="oder--card-icon">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('admin.orders.list', ['status' => 'delivered'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('public/assets/admin/img/icons/delivered.png')}}" alt=""
                                        class="oder--card-icon">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('admin.orders.list', ['status' => 'canceled'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('public/assets/admin/img/icons/canceled.png')}}" alt=""
                                        class="oder--card-icon">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a type="submit" class="dropdown-item d-flex align-items-center gap-2"
                                    href="{{route('admin.orders.export-excel', ['search' => $search, 'from' => $from, 'to' => $to, 'status' => $status, 'branch_id' => $branchId])}}">
                    ...
                    <tbody id="set-rows">
                        ...
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td class="text-capitalize">
                                ...
                                @else
                                    <span
                                        class="badge-soft-danger px-2 py-1 rounded">{{str_replace('_', ' ', $mapped_status)}}</span>
                                @endif
                            </td>
                            <td>
                                ...
                                @else
                                    <span
                                        class="badge-soft-info px-2 py-1 rounded">{{translate($order['order_type'])}}</span>
                                @endif
                            </td>
                            <td>

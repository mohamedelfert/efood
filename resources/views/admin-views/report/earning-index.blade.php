                    ...
                    <div class="col-12">
                        <form action="{{url()->current()}}" method="get">
                            <div class="row g-2">
                                ...
                                <div class="col-sm-4">
                                    <div class="">
                                        <input type="date" name="from" id="from_date" value="{{ $startDate }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="">
                                        <input type="date" name="to" id="to_date" value="{{ $endDate }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="">

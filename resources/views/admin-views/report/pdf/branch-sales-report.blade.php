    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 40%;">{{ translate('product_name') }}</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $row['product_details'] ? json_decode($row['product_details'], true)['name'] ?? translate('not_available') : translate('not_available') }}</td>

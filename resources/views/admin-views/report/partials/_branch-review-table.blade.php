                        ...
                        @if($review->attachment && count($review->attachment) > 0)
                            <div class="d-flex gap-1">
                                @foreach($review->attachment as $img)
                                    <img src="{{ asset('storage/app/public/review/' . $img) }}" alt="review" class="rounded"
...
@else
    <div class="text-center py-5">
        <img src="{{asset('public/assets/admin')}}/svg/illustrations/sorry.svg" alt="no data" class="mb-3"
            style="width: 100px;">

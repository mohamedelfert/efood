                                            ...
                                            <tr>
                                                ...
                                                <td class="text-capitalize">
                                                    <div class="media align-items-center gap-3">
                                                        <div class="avatar">
                                                            <img class="img-fit rounded-circle" src="{{$employee->imageFullPath}}"
                                                ...
                                                <td>
                                                    <div><a class="text-dark"
                                                            href="mailto:{{$employee['email']}}"><strong>{{$employee['email']}}</strong></a>
                                                    </div>
                                                    <div><a href="tel:{{$employee['phone']}}"
                                                            class="text-dark">{{$employee['phone']}}</a></div>
                                                </td>
                                                <td><span class="badge badge-soft-info py-1 px-2">{{$employee->role['name']}}</span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span class="badge badge-soft-primary py-1 px-2">
                                                        {{$employee->branch?->name ?? translate('Main Dashboard')}}
                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        ...
                                                        <a data-id="employee-{{$employee->id}}"

    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'key_name' => 'stripe',
                'live_values' => '{"gateway":"stripe","mode":"live","status":"1"}',
                'test_values' => '{"gateway":"stripe","mode":"live","status":"1"}',
                'settings_type' => 'payment_config',
                'mode' => 'test',
                'is_active' => 1,
                'created_at' => '2023-08-30 04:49:15',
                'updated_at' => '2023-08-30 04:49:15',
                'additional_data' => '{"gateway_title":"stripe","gateway_image":""}',
            ],
            [
                'id' => 'c41c0dcd-d119-11ed-9f67-0c7a158e4469',
                'key_name' => 'qib',
                'live_values' => '{"gateway":"qib","mode":"live","status":"1"}',
                'test_values' => '{"gateway":"qib","mode":"live","status":"1"}',
                'settings_type' => 'payment_config',
                'mode' => 'test',
                'is_active' => 1,
                'created_at' => '2023-08-30 04:49:15',

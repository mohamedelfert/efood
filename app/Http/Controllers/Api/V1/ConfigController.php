...
class ConfigController extends Controller
{
    ...
    public function configuration(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'dm_self_registration' => (boolean) (Helpers::get_business_settings('dm_self_registration') ?? 0),
            'toggle_dm_registration' => (boolean) (Helpers::get_business_settings('dm_self_registration') ?? 0),
            'toggle_veg_non_veg' => (boolean) (Helpers::get_business_settings('toggle_veg_non_veg') ?? 0),
            'is_veg_non_veg_active' => (boolean) (Helpers::get_business_settings('toggle_veg_non_veg') ?? 0),
